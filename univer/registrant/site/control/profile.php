...
//	exit(0);
		...
		<table width=100% border=0>
			...
			<table border=0 cellspacing=5 width=100%>
				<tr height=30px >
					...
					<input type=hidden name=\"a\" value=\"update_profile\">
	...
	for ($i=0; $i < 10; $i++) {
		print("
		<tr><td bgcolor=#e0e0e0 class=\"param\" valign=top align=left >
			Компания:</td>
		    <td class=\"old_value\" valign=top align=left >
		    	sdfsdfsdf sdfg sdgds</td>
		    <td class=\"new_value\" valign=center align=left >
		    	<input maxlenght=255 type=text name=\"\" value=\"\" > </td>
		</tr>
		");
	}
