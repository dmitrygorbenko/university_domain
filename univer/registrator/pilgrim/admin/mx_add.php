<?php
	...
	function body_page() {
		...
		echo "
			<form action=\"mx_action.php?act=add_mx\" method=\"POST\" name=\"mx_manage\">
			...
			<tr height=\"40px\">
				<td colspan=\"2\">
					<input class=\"simple_button\" type=\"submit\" value=\"Create MX Server\">
				</td>
			</tr>
			</table>
			</form>
		<script language=\"javascript\">
			document.mx_manage.domain.focus();
		</script>
