<?php
	...
	function body_page() {
		...
		$zone_plain_text = $PM->SDC->fetch_zone_plain_text($id_zone);

		if ($zone_plain_text == FALSE) {
			echo "Can't fetch zone plain text: ".$_SESSION["adminpanel_error"];
			return;
		}
		...
		<table cellspacing=\"3\" cellpadding=\"0\" border=\"0\" width=\"100%\">
				...
				<td colspan=\"6\" width=\"100%\">
					...
					<tr valign=\"center\" height=\"62\" width=\"100%\">
						...
						<td height=\"62\" width=\"99%\" align=\"left\" background=\"../img/table/table_background.jpg\" class=\"title\" colspan=\"3\">
							Manage Hosting Zone <a class=\"title\" href=\"zone_change.php?id=".$id_zone."\">".$zone->fqdn."</a> of client <a class=\"title\" href=\"client_change.php?id=".$client->id_table."\">".$client->login."</a>
						</td>
			...
			<tr valign=\"top\">
				<td colspan=\"6\" width=\"100%\">
					<form action=\"zone_manage_action.php\" method=POST name=\"create_record\">
					<input type=\"hidden\" name=\"manual\" value=\"on\">
					<input type=\"hidden\" name=\"id_zone\" value=\"".$id_zone."\">
					<input type=\"button\" class=\"simple_button\" onClick=\"document.location='zone_manage_change.php?id_zone=".$id_zone."'\" value=\"Script Mode\">
				</td>
			</tr>
			<tr valign=\"top\">
				<td colspan=\"6\" width=\"100%\">
